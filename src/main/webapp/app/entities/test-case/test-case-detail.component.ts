...
export class TestCaseDetailComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.jhiLanguageService.setLocations(['testCase']);
    }
    ...
    registerChangeInTestCases() {
        this.eventSubscriber = this.eventManager.subscribe('testCaseListModification', (response) => this.load(this.testCase.id));
    }
}
